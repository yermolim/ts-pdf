...
declare const colorSpaces: {
	readonly GRAYSCALE: "/DeviceGray";
	readonly RGB: "/DeviceRGB";
	readonly CMYK: "/DeviceCMYK";
	readonly SPECIAL: "/DeviceN";
	readonly SPECIAL_INDEXED: "/Indexed";
	readonly SPECIAL_PATTERN: "/Pattern";
	readonly SPECIAL_SEPARATION: "/Separation";
};
export declare type ColorSpace = typeof colorSpaces[keyof typeof colorSpaces];
...
declare class IndexedColorSpaceArray implements IEncodable {
	...
	constructor(baseColorSpace: string, highestValue: number, lookupArray: Uint8Array);
	static parse(parseInfo: ParseInfo, skipEmpty?: boolean): ParseResult<IndexedColorSpaceArray>;
	toArray(cryptInfo?: CryptInfo): Uint8Array;
...
declare class ImageStream extends PdfStream {
	...
	toArray(cryptInfo?: CryptInfo): Uint8Array;
	getImageUrlAsync(): Promise<string>;
	protected parseProps(parseInfo: ParseInfo): void;
...
declare class ResourceDict extends PdfDict {
	...
	protected _xObjectsMap: Map<string, ImageStream | XFormStream>;
	constructor();
	...
	getXObjects(): Iterable<[
		string,
		XFormStream | ImageStream
	]>;
	setXObject(name: string, xObject: XFormStream | ImageStream): void;
